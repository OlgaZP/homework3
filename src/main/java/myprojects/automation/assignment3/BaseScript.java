...
public abstract class BaseScript {
    ...
    public static WebDriver getDriver() {
        ...
        switch (browser) {
            ...
            default:
                ...
                System.out.println("Path to driver :" +BaseScript.class.getResource("/chromedriver.exe").getPath());
    ...
    public static EventFiringWebDriver getConfiguredDriver() {
        ...
        System.out.println("Get driver to getConfiguredDriver");
       // TODO configure browser window (set timeouts, browser pindow position) and connect loggers.
        driver.manage().window().maximize();
        EventFiringWebDriver driverWithLog = new EventFiringWebDriver(driver);
        WebDriverLogger ConfigureLogger = new WebDriverLogger();
        driverWithLog.register(ConfigureLogger);
        System.out.println("Registered listener");

        return driverWithLog;
